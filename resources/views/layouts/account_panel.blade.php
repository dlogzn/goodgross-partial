...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/assets/css/AccountPanel/default.css') }}">
    ...
    <script src="{{ asset('/assets/js/common/default.js') }}"></script>
    <script src="{{ asset('/assets/js/common/ajax_initialization.js') }}"></script>
</head>
<body>

@include('includes.AccountPanel.header')
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mx-auto">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-3">
                    @include('includes.AccountPanel.left_nav')
                </div>
...
@include('includes.AccountPanel.footer')
